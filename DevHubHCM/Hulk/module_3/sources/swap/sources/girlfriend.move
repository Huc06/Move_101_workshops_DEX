...
//One Time witness
public struct GIRLFRIEND has drop {}

fun init(witness: GIRLFRIEND, ctx: &mut TxContext) {
...
entry fun mint_token(treasury_cap: &mut TreasuryCap<GIRLFRIEND>, ctx: &mut TxContext) {
