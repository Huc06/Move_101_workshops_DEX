...
public struct SAO_TOKEN has drop {}

fun init(witness: SAO_TOKEN, ctx: &mut TxContext) {
...
entry fun mint_token(treasury_cap: &mut TreasuryCap<SAO_TOKEN>, ctx: &mut TxContext) {
    let coin_object = coin::mint(treasury_cap, 1_000_000_000_000, ctx); // 1,000 sao with 9 decimals
